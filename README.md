...
A book review web application and REST API built with Python, Django,
Django REST Framework, PostgreSQL, and Docker.
...
**Tech stack:**  
`Python` `Django` `Django REST Framework` `PostgreSQL` `pytest` `Docker` `GitHub Actions`

---

### [Recipe App API](https://github.com/rwiszowaty/recipe-app-api)

Educational REST API project developed as part of the Udemy course
**Backend REST API with Python & Django - Advanced**.

Built to practice REST API development, automated testing, Docker,
PostgreSQL, and CI.
